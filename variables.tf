variable "cloudfront_distribution_config" {
  ...
  type = list(
    object(
      {
        id      = string                  # Random string used for internal Terraform identification of this resource.
        ...
        default_cache_behavior = object( # The default cache behavior for this distribution (maximum one).
          {
            ...
            cache_policy = optional(                # Information about a CloudFront cache policy.
              object(
                {
            ...
            min_ttl = optional(string)        # The minimum amount of time that you want objects to stay in CloudFront caches before CloudFront queries your origin to see whether the object has been updated. Defaults to 0 seconds.
            origin_request_policy = optional( # Origin request policy.
              object(
                {
                  id      = optional(string) # Random string used for internal Terraform identification of this item.
            ...
            response_headers_policy = optional( # Response headers policy.
              object(
                {
                  comment = optional(string) # Any comments you want to include about the distribution.
                    ...
                    object(
                      {
                        ...
                        access_control_allow_headers = optional(          # Object that contains an attribute items that contains a list of HTTP header names that CloudFront includes as values for the Access-Control-Allow-Headers HTTP response header.
                          object(
                            {
                              items = optional(set(string)) # Item of HTTP header name. Example: "test".
                            }
                          )
                        )
                        access_control_allow_methods = optional( # Object that contains an attribute items that contains a list of HTTP methods that CloudFront includes as values for the Access-Control-Allow-Methods HTTP response header. 
                          object(
                            {
                              items = optional(set(string)) # Item of HTTP methods. Valid values: GET | POST | OPTIONS | PUT | DELETE | HEAD | ALL.
                            }
                          )
                        )
                        access_control_allow_origins = optional( # Object that contains an attribute items that contains a list of origins that CloudFront can use as the value for the Access-Control-Allow-Origin HTTP response header.
                          object(
                            {
                              items = optional(set(string)) # Item of used as the value for the Access-Control-Allow-Origin HTTP response header. Example: "test.example.comtest".
                            }
                          )
                        )
                        access_control_expose_headers = optional( # Object that contains an attribute items that contains a list of HTTP headers that CloudFront includes as values for the Access-Control-Expose-Headers HTTP response header.
                          object(
                            {
                              items = optional(set(string)) # Item of used as the value for the Access-Control-Expose-Headers HTTP response header.
                            }
                          )
                        )
            ...
            object(
              {
                ...
                cache_policy = optional( # CloudFront cache description.
                  object(
                    {
                      name        = optional(string)                              # A unique name to identify the cache policy.
                      comment     = optional(string)                              # A comment to describe the cache policy.
                ...
                # realtime_log_config_arn = optional(string).
                response_headers_policy = optional( # Description of response headers policy.
                  object(
                    {
                        ...
                        object(
                          {
                            ...
                            access_control_allow_headers = optional(          # Object that contains an attribute items that contains a list of HTTP header names that CloudFront includes as values for the Access-Control-Allow-Headers HTTP response header.
                              object(
                                {
                                  items = optional(set(string)) # Attribute items that contains a list of HTTP header names.
                                }
                              )
                            )
                            access_control_allow_methods = optional( # Object that contains an attribute items that contains a list of HTTP methods that CloudFront includes as values for the Access-Control-Allow-Methods HTTP response header. 
                              object(
                                {
                                  items = optional(set(string)) # Attribute items that contains a list of HTTP methods. Valid values: GET | POST | OPTIONS | PUT | DELETE | HEAD | ALL.
                                }
                              )
                            )
                            access_control_allow_origins = optional( # Object that contains an attribute items that contains a list of origins that CloudFront can use as the value for the Access-Control-Allow-Origin HTTP response header.
            ...
            object(
              {
                ...
                custom_header = optional( # One or more sub-resources with name and value parameters that specify header data that will be sent to the origin (multiples allowed).
                  list(
                    object(
                      {
                        name  = optional(string) # Sub-resources name.
                        value = optional(string) # Sub-resources value.
                      }
                    )
                  )
                )
                ...
                origin_shield = optional(                   # The CloudFront Origin Shield configuration information. Using Origin Shield can help reduce the load on your origin. For more information, see Using Origin Shield in the Amazon CloudFront Developer Guide.
                  object(
                    {
                      enabled              = optional(string) # A flag that specifies whether Origin Shield is enabled.
                      origin_shield_region = optional(string) # The AWS Region for Origin Shield. To specify a region, use the region code, not the region name. For example, specify the US East (Ohio) region as us-east-2.
                    }
                  )
                )
        ...
        restrictions = optional(       # The restriction configuration for this distribution (maximum one).
          object(
            {
